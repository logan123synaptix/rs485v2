...
/**
 * @brief Polls the user Modbus application.
 *
 * This function should be called periodically to handle Modbus-related tasks
 * in the user application. It manages communication, processes requests,
 * and updates internal states as required by the Modbus protocol.
 */
